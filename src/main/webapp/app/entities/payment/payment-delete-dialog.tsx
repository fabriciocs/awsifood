...
export const PaymentDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.ifoodapp.payment.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="iFoodApp.payment.delete.question">
        <Translate contentKey="iFoodApp.payment.delete.question" interpolate={{ id: paymentEntity.id }}>
