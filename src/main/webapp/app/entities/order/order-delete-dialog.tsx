...
export const OrderDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.ifoodapp.order.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="iFoodApp.order.delete.question">
        <Translate contentKey="iFoodApp.order.delete.question" interpolate={{ id: orderEntity.id }}>
